...
class Proxy
  ...
  # Обработка вызовов методов, которые не существуют в Proxy
  def method_missing(method_name, *args, &block)
    # Сохраняем имя метода в массив сообщений
    @messages << method_name

    # Увеличиваем количество вызовов для метода
    @method_calls[method_name] += 1

    # Перенаправляем метод на целевой объект
  ...
  # Возвращает массив всех вызванных методов
  def messages
    @messages
  end
  ...
  # Возвращает количество вызовов для метода
